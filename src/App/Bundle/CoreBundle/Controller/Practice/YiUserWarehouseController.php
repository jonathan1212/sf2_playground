...
use App\Bundle\CoreBundle\Entity\YiUserwarehouse;
/**
 * User controller.
 *
 */
class YiUserWarehouseController extends Controller
{
    ...
    {
        $em = $this->get('doctrine')->getManager();
        $yiUserwarehouse = $em->getRepository('AppCoreBundle:YiUserwarehouse')->find(1);

        $x = new YiUserwarehouse();
        //$x->addYiProductwarehouse(null);

        $form = $this->createForm('user_warehouse', $x, array());
        ...
        return $this->render('AppCoreBundle:YiUserWarehouse:new.html.twig', $data);
    }
